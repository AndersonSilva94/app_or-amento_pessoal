...
class Bd {
    ...
    recuperarTodosRegistros(){
        ...
        for( let i = 1; i <= id; i++){
            ...
            //existe a possibilidade de existirem índices que foram pulados ou removidos
            //neste caso nós vamos pular o índice
            if(despesa === null){
                continue
            }
...
function cadastrarDespesa(){
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('modal-mensagem').innerHTML = 'Despesa foi cadastrada com sucesso!'
        document.getElementById('modal-botao').innerHTML = 'Voltar'
        document.getElementById('modal-botao').className = 'btn btn-success'
        //dialog de acerto
        $('#modal-registro-despesa').modal('show')
        ...
        document.getElementById('modal-mensagem').innerHTML = 'Erro na gravação, verifique se todos os campos foram preenchidos corretamente'
        document.getElementById('modal-botao').innerHTML = 'Voltar e verificar'
